<?php
	//if(!isset($_GET["v"]))
		//exit();
	header('Access-Control-Allow-Origin: https://www.filmmodu.org');
	...
	$stream = new VideoStream("https://www.filmmodu.org/get-source?movie_id=2822&type=tr");
	$stream->start();
	...
	class VideoStream
	{
		...
		private function setHeader()
		{
			...
			header('Content-Disposition: inline; filename="Bolüm 137.mp4"');
			$this->start = 0;
